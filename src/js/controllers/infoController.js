...
var infoController = function($scope, $routeParams, infoServices, platformServices, errorServices, toastServices, localStorageService, config) {
    ...
    $scope.share = function() {
        platformServices.share({
            title: $scope.result.info.title,
            content: $scope.result.info.details,
            thumbnail: $scope.result.images[0].image
        });
    }
}
